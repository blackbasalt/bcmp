...
urlpatterns = [
    ...
    # Тоже не экран, а правая панель экрана этажа: помещение называет себя само, и
    # этаж в адресе ему не нужен — по дереву ходят, не выходя с этажа, на котором стоят.
